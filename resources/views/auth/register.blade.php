                ...
                <div class="form-floating mb-3">
                    ...
                    <div class="dropdown">
                        <select class="selectpicker" data-live-search="true">
                            ...
                            <option data-tokens="DIRECCION">DIRECCIÓN</option>
                            ...
                            <option data-tokens="UNIDAD_DE_PLANEAMIENTO_Y_DESARROLLO_INSTITUCIONAL">UNIDAD DE PLANEAMIENTO Y
                                DESARROLLO INSTITUCIONAL</option>
                            <option data-tokens="UNIDAD_DE_ASESORIA_JURIDICA">UNIDAD DE ASESORIA JURIDICA</option>
                            <option data-tokens="UNIDAD_DE_EDUCACION_BASICA_TECNICO_PRODUCTIVA">UNIDAD DE EDUCACIÓN BÁSICA
